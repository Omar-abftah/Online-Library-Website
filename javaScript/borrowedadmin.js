...
borrowedBooks.forEach(function(book) {
  ...
  row.insertCell().textContent = book.borrowerName;
  row.insertCell().textContent = book.email;
  row.insertCell().textContent = book.telephone;
  row.insertCell().textContent = book.nationalId;
